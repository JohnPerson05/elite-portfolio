...
/**
 * `DeleteProjectButton` — a guarded delete control with a confirmation dialog
 * (Requirement 10.3).
 *
 ...
 * invokes the {@link deleteProject} Server Action (which itself re-checks the
  ...
  return (
    <>
      ...
      <dialog
        ...
        role="alertdialog"
        aria-modal="true"
        aria-labelledby={`delete-title-${projectId}`}
        aria-describedby={`delete-desc-${projectId}`}
        onClose={() => {
          setOpen(false);
          setDeleting(false);
        }}
        ...
        <div className="flex flex-col gap-space-3">
          ...
          <div className="mt-space-2 flex flex-wrap items-center justify-end gap-space-2">
            ...
            <Button
              ...
              disabled={deleting}
            >
              {deleting ? PROJECT_DELETING_LABEL : PROJECT_DELETE_CONFIRM}
            </Button>
          </div>
        </div>
      </dialog>
